...
The impact of the gender increase the "risk" of finishing the race by 1.17 meaning that the female have 0.85 times more chance to finish the race than male.
...
## e/ Comparison of the Cox models

Let's compare the different Cox models and see which is the "best" one using AIC: cox.full, cox.age, cox.gender, cox.age_gender1 (no interaction) and cox.age_gender2 (with interaction)

```{r}
fits<- list(M0 = cox.full, MA = cox.age, MB = cox.gender, MC1 = cox.age_gender1, MC2=cox.age_gender2, MC3 = cox.age_gender3)
sapply(fits, AIC)
```
We can see that the best model (with lowest AIC) is the model considering the covariate "gender".


```{r}

# Proportionality of hazards : complementary log-log plot
# In this figure we see that the different age_ranges are not parellel which indicates that the proportionality of hazards is not respected
